...
class PraatCC(PitchDetector):
    """https://parselmouth.readthedocs.io/en/stable/api_reference.html#parselmouth.Sound.to_pitch_cc"""
    ...
    def __init__(
        ...
        self.pitch_obj = self.signal.to_pitch_cc(pitch_floor=hz_min, pitch_ceiling=hz_max, very_accurate=True)
