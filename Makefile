...
build:
	...
	DOCKER_BUILDKIT=1 docker build --progress=plain -t tandav/pitch-detectors:12.8.0-cudnn8-devel-ubuntu22.04 .
...
test: build
	...
	tandav/pitch-detectors:12.8.0-cudnn8-devel-ubuntu22.04 \
	pytest -v
